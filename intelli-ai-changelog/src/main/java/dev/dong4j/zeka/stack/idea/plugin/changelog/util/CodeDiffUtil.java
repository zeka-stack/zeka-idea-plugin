...
public final class CodeDiffUtil {
    ...
    private static DiffResult extractDiffResult(@NotNull Change change) {
        return ApplicationManager.getApplication().runReadAction((Computable<DiffResult>) () -> {
            try {
                ...
                String diff = generateUnifiedDiffInternal(
                    beforeFileName,
                    afterFileName,
                    beforeContent,
                    afterContent,
                ...
                diff = truncateDiffIfNeeded(diff);
    ...
    private static String generateUnifiedDiffInternal(@NotNull String beforeFileName,
        ...
        String result = hasChanges ? diff.toString() : "";
        return truncateDiffIfNeeded(result);
    }
     ...
     */
    @NotNull
    private static String truncateDiffIfNeeded(@NotNull String diff) {
