...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/ai/AIConsoleLoggerImpl.java`
...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/console/JavaDocConsoleView.java`
...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/ai/JavaDocAIStreamResponseListener.java`
