package dev.dong4j.zeka.stack.idea.plugin.archiver.icons;
...
public class ArchiverIcons {
    ...
    private static Icon load(@NotNull String iconPath) {
        return IconLoader.getIcon(iconPath, ArchiverIcons.class);
    }
     ...
     */
    public static final Icon ARCHIVER_16 = load("/icons/archiver_16.svg");
}
