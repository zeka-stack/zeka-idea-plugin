...
public class NotificationUtil {
    public static final String NOTIFICATION_GROUP_ID = "Archiver Man Notifications";
    ...
    public static void showInfo(@Nullable Project project, @NotNull String message) {
        notify(project, ArchiverBundle.message("notification.title"), message, NotificationType.INFORMATION);
    }

    public static void showWarning(@Nullable Project project, @NotNull String message) {
        notify(project, ArchiverBundle.message("notification.title"), message, NotificationType.WARNING);
    }

    public static void showError(@Nullable Project project, @NotNull String message) {
        notify(project, ArchiverBundle.message("notification.title"), message, NotificationType.ERROR);
    }
