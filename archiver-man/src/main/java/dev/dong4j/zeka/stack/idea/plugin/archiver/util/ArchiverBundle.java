 ...
 * @since 1.0.0
 */
public class ArchiverBundle extends DynamicBundle {

    @NonNls
    private static final String BUNDLE = "messages.ArchiverBundle";

    private static final ArchiverBundle INSTANCE = new ArchiverBundle();

    private ArchiverBundle() {
        super(BUNDLE);
    }
