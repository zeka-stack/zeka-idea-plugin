...
REMOTE_HOST="aliyun"
REMOTE_DIR="/var/www/archiver-man-landing"
REMOTE_LANDING_PATH="$REMOTE_DIR/landing.html"
REMOTE_DOCS_DIR="/var/www/archiver-man-docs"
DEST_ZIP_NAME="archiver-man.zip"
