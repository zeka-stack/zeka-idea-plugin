...
public class NotificationUtil {
     ...
     * 通知分组的 ID
     */
    public static final String NOTIFICATION_GROUP_ID = "AI Workflow Explainer Notifications";
    ...
    public static void showInfo(@Nullable Project project, @NotNull String message) {
        notify(project, "AI Workflow Explainer", message, NotificationType.INFORMATION);
    }
    ...
    public static void showWarning(@Nullable Project project, @NotNull String message) {
        notify(project, "AI Workflow Explainer", message, NotificationType.WARNING);
    }
    ...
    public static void showError(@Nullable Project project, @NotNull String message) {
        notify(project, "AI Workflow Explainer", message, NotificationType.ERROR);
    }
