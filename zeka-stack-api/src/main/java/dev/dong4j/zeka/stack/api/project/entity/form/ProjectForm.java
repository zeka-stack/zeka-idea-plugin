...
public class ProjectForm extends BaseForm<Long> {
    ...
    @NotBlank(message = "[项目唯一标识 (如 zeka-idea-plugin)] 必填)")
    private String key;
    /** 项目显示名称 */
    @Schema(description = "项目显示名称")
    @NotBlank(message = "[项目显示名称] 必填)")
    private String name;
    /** 项目描述 */
    ...
    @NotNull(message = "[排序权重] 必填)")
    private Integer sortOrder;
    /** 状态: 1-启用, 0-禁用 */
    @Schema(description = "状态: 1-启用, 0-禁用")
    @NotNull(message = "[状态: 1-启用, 0-禁用] 必填)")
