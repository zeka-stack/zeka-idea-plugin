...
import dev.dong4j.zeka.stack.idea.javadoc.task.TaskStatistics;
...
public class DocumentationGenerationService {
     ...
     *
     * @param project 项目对象, 用于标识当前操作的上下文
     * @param tasks   文档生成任务列表
     * @param message 提示信息内容, 用于通知用户任务列表为空的情况
     * @return 如果任务列表为空, 返回 true; 否则返回 false
     */
