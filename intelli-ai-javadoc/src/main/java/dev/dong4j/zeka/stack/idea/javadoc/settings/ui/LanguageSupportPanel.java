...
public class LanguageSupportPanel {
    ...
    /** Java 语言支持选项框, 用于控制是否启用 Java 语言支持. */
    private JBCheckBox javaCheckBox;

    /**
     * Kotlin 语言支持开关控件
     * <p>
     * 表示是否启用 Kotlin 语言支持的复选框.
     *
     * @see #getPanel()* @see #getSettings(SettingsState)
     * @see #loadSettings(SettingsState)
     */
     ...
     * 创建 UI
     * <p>
     * 初始化语言支持相关的用户界面组件, 包括 Java,Kotlin 语言支持复选框以及生成 Javadoc 提示设置.
     */
     ...
     * 加载设置
     *
     * @param settings 设置对象, 用于从配置中读取语言支持和生成 Javadoc 提示的配置
     */
