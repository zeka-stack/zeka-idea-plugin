...
public class JavadocDeletionService {
    ...
    private void collectKotlinElementsWithComments(@NotNull KtFile file, @NotNull List<PsiElement> results) {
        file.acceptChildren(new org.jetbrains.kotlin.psi.KtTreeVisitorVoid() {
            /**
             * 处理类或对象节点, 若该节点包含文档注释则将其添加到结果列表中
             * <p> 此方法用于遍历 Kotlin 语法树中的类或对象节点, 并检查其是否包含文档注释. 如果存在文档注释, 则将该节点添加到结果集合中.
             *
             * @param klass 被访问的类或对象节点, 不能为空
             */
            @Override
            ...
            /**
             * 访问命名函数
             * <p> 此方法在访问命名函数时被调用. 如果函数具有文档注释, 则将其添加到结果列表中.
             *
             * @param function 要访问的命名函数, 不能为 null
             */
            @Override
            ...
            /**
             * 处理属性节点, 若属性包含文档注释则将其添加到结果列表中
             * <p> 此方法用于遍历属性节点, 并检查其是否包含文档注释. 如果存在文档注释, 则将该属性添加到结果列表中.
             *
     ...
     * @return 如果元素包含文档注释则返回 true, 否则返回 false
     */
