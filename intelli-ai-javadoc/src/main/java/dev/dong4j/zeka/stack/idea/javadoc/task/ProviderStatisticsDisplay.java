...
/**
 * 显示提供商的统计信息, 包括 HTML 格式的表格和日志信息.
 * <p>
 * 该方法接收一个包含提供商统计信息的 Map, 生成 HTML 格式的统计表格, 并在日志中记录详细信息.
 * 同时, 会弹出一个对话框展示统计结果.
 *
 * @param project       当前项目上下文, 用于日志输出
 * @param providerStats 包含提供商统计信息的 Map, 键为服务商名称, 值为对应的统计对象
 */
public final class ProviderStatisticsDisplay {

    /**
     * 私有构造函数, 用于防止外部实例化
     * <p> 该构造函数是私有的, 仅用于防止其他类创建 {@link ProviderStatisticsDisplay} 的实例.
     *
     */
