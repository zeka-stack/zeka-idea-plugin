...
import dev.dong4j.zeka.stack.idea.javadoc.settings.ui.JavadocSettingsPanel;
...
public class JavadocSettingsConfigurable implements SearchableConfigurable {
     ...
     *
     * @return 设置面板的根组件
     * @see JavadocSettingsPanel#getPanel()* @see #disposeUIResources()
     */
    @Nullable
    @Override
     ...
     * 检查配置是否已修改
     *
     * <p> 比较当前配置和面板中的配置是否一致. 用于确定是否需要显示 "Apply" 按钮.
     *
     * <p> 比较策略:
     * <ul>
     * <li> 逐项比较所有配置项 </li>
     ...
     * @see SettingsState#getInstance()* @see JavadocSettingsPanel#getSettings()
     */
    @SuppressWarnings("D")
    @Override
     ...
     *   <li> 获取面板中的配置 </li>
     *   <li> 将配置复制到全局配置实例 </li>
     *   <li> 在后台线程中应用配置到所有打开的项目 </li>
     *   <li> 同步自定义 Javadoc 标签 </li>
     * </ol>
     *
     * <p> 异常处理:
     * <ul>
