...
public class TaskExecutor {
     ...
     *
     * <p>该类负责协调和管理任务执行过程中的进度显示, 支持确定模式和不确定模式的进度指示.
     * 在并行处理模式下, 它会收集各提供者的统计信息, 并在任务完成后更新整体进度.
     * 该管理器与进度指示器 (ProgressIndicator) 协同工作, 确保用户界面能够实时反映任务执行状态.
     *
     ...
     * 构造任务执行器
     *
     * @param project   项目对象, 用于表示当前操作的项目上下文
