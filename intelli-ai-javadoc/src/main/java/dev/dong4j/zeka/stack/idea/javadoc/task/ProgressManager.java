...
public class ProgressManager {
     ...
     * 多线程模式下的提供商统计信息映射 (可选)
     * <p>
     * 该字段用于存储多线程模式下各个任务提供商的统计信息, 包括已完成, 失败和跳过的任务数量.
     * 在单线程模式下, 该字段为 null.
     *
     * @see #isParallelMode() 判断是否为多线程模式
     * @see #getProviderStats() 获取提供商统计信息映射
     */
     ...
     * 创建单线程模式的进度管理器
     *
     * @param indicator  进度指示器, 用于更新任务进度信息
     * @param totalTasks 总任务数, 表示需要处理的任务总量
     */
     ...
     * 判断是否为多线程模式
     *
     * @return 如果是多线程模式返回 true, 否则返回 false
     */
