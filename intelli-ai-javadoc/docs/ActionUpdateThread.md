...
检查 intelli-ai-javadoc 项目中所有使用 `ActionUpdateThread.BGT` 或 `ActionUpdateThread.EDT` 的代码，找出本应该使用 EDT 却使用了 BGT 的情况。
...
- `intelli-ai-javadoc/docs/ActionUpdateThread修复说明.md`
