# IntelliJ IntelliAI JavaDoc 插件操作手册
...
**IntelliAI JavaDoc: You Know, for Javaer, Fun**
...
IntelliJ IntelliAI JavaDoc 插件是一个功能强大的工具，利用人工智能为您的 Java 代码自动生成高质量的 JavaDoc 注释。插件支持多种 AI
...
1. 打开 IntelliJ IDEA
2. 进入 **Settings**（macOS 上为 Preferences）→ **Tools** → **IntelliAI JavaDoc**
3. 选择 AI 提供商（推荐通义千问）
4. 配置 API Key 和模型
...
**路径**：Settings → Tools → IntelliAI JavaDoc
