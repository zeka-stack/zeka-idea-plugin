...
public final class AutocompleteRejectActionHandler extends EditorActionHandler {
    private final EditorActionHandler originalHandler;

    public AutocompleteRejectActionHandler(@NotNull EditorActionHandler originalHandler) {
        super(true);
