...
/**
 * OpenRouter OpenAI 兼容提供商实现类
 */
public class OpenRouterProvider extends OpenAILikeProvider {

    /**
     * 初始化 OpenRouter OpenAI 兼容提供者实例
     *
     ...
     */
    public OpenRouterProvider(@NotNull Project project,
