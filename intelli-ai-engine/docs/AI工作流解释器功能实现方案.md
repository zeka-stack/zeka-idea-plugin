...
AI 工作流解释器（IntelliTrace Analyzer）是一个 IntelliJ IDEA 插件功能，旨在帮助开发者理解代码方法的调用上下文和业务流程。当用户在代码编辑器中选中某个方法调用时，插件能够：
...
```
intelli-ai-engine/src/main/java/dev/dong4j/zeka/stack/idea/plugin/common/workflow/
...
```
intelli-ai-engine/src/main/java/dev/dong4j/zeka/stack/idea/plugin/common/workflow/util/
