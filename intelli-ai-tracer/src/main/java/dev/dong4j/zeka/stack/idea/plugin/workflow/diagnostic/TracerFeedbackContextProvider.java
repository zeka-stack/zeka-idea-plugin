package dev.dong4j.zeka.stack.idea.plugin.workflow.diagnostic;
...
/**
 * Tracer 反馈上下文提供者
 * <p> 用于标识上报来源为 IntelliAI Tracer 插件.</p>
 *
 * @author dong4j
 * @version 1.0.0
 * @date 2026.01.28
 * @since 1.0.0
 */
public class TracerFeedbackContextProvider extends AbstractFeedbackContextProvider {
