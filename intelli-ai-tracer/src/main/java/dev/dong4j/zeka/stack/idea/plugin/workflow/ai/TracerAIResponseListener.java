package dev.dong4j.zeka.stack.idea.plugin.workflow.ai;
...
/**
 * TracerAIResponseListener 类
 * <p>
 * 用于监听 AI 请求和响应过程, 记录相关日志信息, 包括请求内容, 响应内容以及 Token 使用情况, 便于调试和追踪 AI 调用流程.
 *
 ...
 * @since 1.0.0
 */
public class TracerAIResponseListener implements AIResponseListener {
    ...
    /**
     * 初始化 TracerAIResponseListener 实例
     * <p>
     * 为监听器设置关联的项目信息
     *
     ...
     */
    public TracerAIResponseListener(@NotNull Project project) {
     ...
     * 处理请求并记录相关信息
     * <p>
     * 该方法用于在接收到请求时, 记录请求的提供者名称和模型名称, 并在请求体不为空时记录请求体内容.
     *
     ...
     * 记录指定模型的 Token 使用情况
     * <p>
     * 当模型被使用时, 记录提供者名称, 模型名称以及 Prompt,Completion 和 Total 的 Token 数量.
     *
     * @param providerName     提供者名称
     * @param modelName        模型名称
