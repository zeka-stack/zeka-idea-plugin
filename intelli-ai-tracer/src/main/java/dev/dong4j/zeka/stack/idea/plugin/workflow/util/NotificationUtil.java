...
public class NotificationUtil {
    ...
    public static void addOpenConfigurablePanelAction(Notification notification, Project project) {
        notification.addAction(new NotificationAction(WorkflowBundle.message("settings.ai.provider.open.engine.settings")) {
            /**
            ...
            public void actionPerformed(@NotNull AnActionEvent e, @NotNull Notification notification) {
                // 打开设置面板
                ShowSettingsUtil.getInstance().editConfigurable(null, "IntelliAI Tracer");
                notification.expire();
            }
        });
