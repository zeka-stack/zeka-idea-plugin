...
import dev.dong4j.zeka.stack.idea.plugin.nacos.PluginDisposable;
 ...
 * @since 1.0.0
 */
public class LocalNacosAppLifecycleListener implements ProjectActivity, ProjectManagerListener {
    /**
     * 标记是否已注册监听器
     * <p>
    ...
    public @Nullable Object execute(@NotNull Project project, @NotNull Continuation<? super Unit> continuation) {
        Disposable parentDisposable = Disposer.newDisposable(PluginDisposable.getInstance(project), "LocalNacosAppLifecycleListener");
        // 确保只注册一次（使用双重检查锁定）
