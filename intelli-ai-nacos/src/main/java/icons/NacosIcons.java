...
public class NacosIcons {
    ...
    private static Icon load(@NotNull String iconPath) {
        return IconLoader.getIcon(iconPath, NacosIcons.class);
    }
     ...
     */
    public static final Icon NACOS_16 = load("/icons/nacos_16.svg");
}
