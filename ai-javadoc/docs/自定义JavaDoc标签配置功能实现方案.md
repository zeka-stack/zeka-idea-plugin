...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/settings/SettingsState.java`
...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/settings/ui/JavaDocSettingsPanel.java`
...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/component/CustomJavaDocTagRegistrar.java`
...
**文件**: `ai-javadoc/src/main/java/dev/dong4j/zeka/stack/idea/plugin/settings/JavaDocSettingsConfigurable.java`
...
**文件**: `ai-javadoc/src/main/resources/messages/JavaDocBundle.properties`
