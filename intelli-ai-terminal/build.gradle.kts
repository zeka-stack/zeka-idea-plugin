...
intellijPlatform {
    ...
    pluginVerification {
        ides {
            // 终端插件依赖 2025.3+ 的新版 Terminal API，重点验证当前版与最新 2026.2。
            create("IU", "2025.3")
            create("IU", "2026.1")
...
dependencies {
    // IntelliJ Platform
    intellijPlatform {
        // terminal api 从 2025.3 开始支持: https://plugins.jetbrains.com/docs/intellij/embedded-terminal.html#adding-dependency-to-the-terminal-plugin
        // 而从 2025.3 开始, 不再区分 IC/IU 发行物, 使用新的写法
